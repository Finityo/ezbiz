...
export const generateLLCGuide = (): jsPDF => {
  ...
  y = addParagraph(doc, `Ready to form your LLC? EZ BIZ FILE SERVICE can handle the entire process for you—from filing your Articles of Organization to obtaining your EIN. Visit ezbiz.lovable.app to get started today, or contact us for a free consultation.`, y);
