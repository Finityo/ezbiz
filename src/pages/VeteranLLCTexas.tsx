...
import { ArrowRight, Shield, Award, FileText, MapPin, AlertTriangle, ClipboardList } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              {[
                { step: "1", title: "Obtain Veteran Verification Letter", description: "Request a Verification Letter from the Texas Veterans Commission for each owner." },
                { step: "2", title: "Complete Comptroller Certification", description: "Fill out Comptroller Certification Form 05-904 (Certification of New Veteran-Owned Business)." },
                { step: "3", title: "Submit Certificate of Formation", description: "Submit your Certificate of Formation along with both required documents to the Texas Secretary of State." },
              ].map((item, i) => (
