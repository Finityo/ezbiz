              ...
              <Card>
                <CardContent className="p-8">
                  <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                      What started as a small practice in New Braunfels, Texas - one of the fastest growing cities in the nation and a thriving business formation market - helping local entrepreneurs and fellow veterans navigate the business formation process, has grown into a nationwide service that has helped over 50,000 businesses get started. We've maintained our small-town values of personal service and integrity while leveraging technology to make the process faster and more efficient.
                    </p>
                    <p className="text-lg text-muted-foreground leading-relaxed">
                      Today, Finityo is proudly headquartered in New Braunfels, TX, and recognized as one of the leading veteran-owned business formation companies in the United States. We never forget our roots in serving our community and the dynamic business environment that shaped us. Every client receives the same personalized attention and expert guidance that built our reputation, backed by our commitment to supporting entrepreneurs the way we wished we had been supported.
                    </p>
                  </div>
                </CardContent>
              </Card>
