          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button asChild size="lg" className="text-lg px-8 py-4 bg-yellow-400 hover:bg-yellow-300 text-slate-900 font-bold shadow-lg hover:shadow-xl border-0" onClick={() => trackClick('Free Consultation', 'corporate_bylaws_cta', '/consultation')}"><Link to="/consultation">Free Consultation</Link></Button>
              </div>
            </div>
          </div>
        </section>
