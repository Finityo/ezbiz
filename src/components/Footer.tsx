          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-8 gap-6 md:gap-8">
            ...
            <div className="col-span-2 space-y-4">
              ...
              <div className="flex flex-col space-y-2 text-sm text-muted-foreground">
                ...
                <a href="mailto:christian@ezbiz-fs.com" onClick={() => trackEmailClick('christian@ezbiz-fs.com')} className="hover:text-foreground transition-colors">✉️ christian@ezbiz-fs.com</a>
