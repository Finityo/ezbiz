export const EZBIZ_COPY = {
  hero: {
    headline: "Business Formation, Done With Discipline.",
    subheadline:
      "Veteran-owned. Texas-based. LLC and corporation filings handled correctly from day one — online or in person.",
    ctaPrimary: "Begin Your Filing",
    ctaSecondary: "Schedule a Consultation",
    trustLine: "Structured. Compliant. No shortcuts.",
    badges: ["Veteran-Owned", "Texas-Based", "Transparent Pricing", "In-Person Filing Available"],
  },

  clarityBlock: {
    heading: "Simple. Transparent. Done Correctly.",
    points: [
      {
  ...
  differentiation: {
    heading: "Why Clients Choose EZ BIZ",
    items: [
      {
  ...
  businessStructures: {
    heading: "Choose Your Business Structure",
    subheading: "From simple to sophisticated, we help you select and form the right entity for your business goals.",
  },

  founder: {
    name: "Christian Talavera",
    credentials: "U.S. Marine Veteran · MBA · MSL",
    title: "Founder, EZ BIZ File Service, LLC",
    bio: "Built on structure, compliance, and clear execution — so your business starts correctly from day one.",
  },

  veteranStrip: {
    heading: "Texas Veteran Filing Benefits",
    subheading: "Eligible veteran-owned Texas businesses may qualify for relief from certain filing fees and franchise tax for up to five years.",
    benefits: [
    ...
    cta: "Check Veteran Eligibility",
  },

  mobileService: {
    badge: "Optional Add-On",
    heading: "White-Glove Mobile Filing",
    description: "Prefer in-person guidance? We can meet at your residence or public location and complete your filing together in real time. This service is ideal for first-time business owners who want structured, step-by-step support.",
    cta: "Learn More About Mobile Service",
    checkboxLabel: "Add Mobile Filing to My Order",
  },
  ...
  leadMagnet: {
    badge: "Free Download",
    heading: "Business Startup Checklist",
    description: "Not sure which structure is right for you? Download our free checklist covering LLC vs. Corporation, tax implications, state requirements, and everything you need before you file.",
    bullets: [
      "Entity type comparison guide",
      "State-by-state filing fee reference",
      "Post-formation compliance timeline",
      "Tax election decision tree",
    ],
  ...
  pricing: {
    ...
    corpPackages: [
      ...
      },
      {
        ...
        description: "Most popular corporation package",
        popular: true,
        features: [
          "Everything in Basic",
          "Bylaws / Initial Minutes (add-on)",
          "Banking Resolution",
          "Initial Compliance Instructions",
          "Priority Support",
        ],
      ...
      {
        name: "Complete Corporation",
        description: "Complete corporation formation with extras",
        features: [
          "Everything in Deluxe",
          "EIN Filing Service",
          "S-Corp Election Filing",
...
// Re-export service page copy from this central file
export { DBA_COPY, EIN_COPY, REGISTERED_AGENT_COPY, ANNUAL_REPORT_COPY, COMPLIANCE_COPY } from "./servicePagesCopy";
